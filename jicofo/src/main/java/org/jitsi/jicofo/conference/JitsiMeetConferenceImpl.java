...
import org.jitsi.jicofo.rest.Pin;
    ...
    implements JitsiMeetConference, XmppProvider.Listener
{
    ...
    public void stop()
    {
        ...
        logger.info("Stopped.");
        //have to call booking API from here.
        Pin.UnpinJson unpinJson;
    ...
    private void callService(String url, String conferenceId, String roomName) {
        String requestBody = "{\n" +
        ...
        HttpRequest request = HttpRequest.newBuilder()
                ...
                .method("POST", HttpRequest.BodyPublishers.ofString(requestBody, StandardCharsets.UTF_8))
                .build();
